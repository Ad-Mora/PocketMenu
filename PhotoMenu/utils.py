...
def get_favorite_foods_context_data(food_ids_list):
    ...
    for food_id in food_ids_list:
        ...
        restaurant = food.menu_category.restaurant
        ...
        favorites_list_from_restaurant = restaurant_data_dict.get(restaurant, [])
        ...
        restaurant_data_dict[restaurant] = favorites_list_from_restaurant
